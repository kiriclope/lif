...
void Set_Parameters(int argc , char** argv, string &dir, int &nbpop, int &N, double &K, double &duration, double &dt, double &Tst, double &Tw, double &g, double* &Iext, double* &IextBL) {
  ...
  if(argv[1] != NULL) {
    ...
    duration = (double) atof(argv[6]) ;
    Tst = (double) atof(argv[7]) ;
    Tw = (double) atof(argv[8]) ;
    g = (double) atof(argv[9]) ;
...
void Set_Parameters_Ka(int argc , char** argv, string &dir, int &nbpop, int &N, double* &K, double &duration, double &dt, double &Tst, double &Tw, double &g, double* &Iext) {
  ...
  if(argv[1] != NULL) {
    ...
    dt = (double) atof(argv[4+nbpop]) ;
    duration = (double) atof(argv[5+nbpop]) ;
    Tst = (double) atof(argv[6+nbpop]) ;
    Tw = (double) atof(argv[7+nbpop]) ;
    g = (double) atof(argv[8+nbpop]) ;
    
    Iext = new double [nbpop] ;      
    for(int i=0;i<nbpop;i++) 
      Iext[i] = (double) atof(argv[i+nbpop+9]) ;
  }
}
...
void Import_Connectivity_Matrix(int nbpop,int N,string Jpath,int* &nbPost,unsigned long int* &idxPost,int* &IdPost, bool IF_Nk) {
...
void Check_Connectivity_Matrix(string Jpath,int nbpop, int N, double K, bool IF_Nk) {
...
void Save_Parameters(string dir, int nbpop, int N, int *Nk, double K, double** J, double duration, double dt, double Tst, double Tw, double *Iext, double *Tm, double **Tsyn, string path) {
...
void Save_Parameters_Ka(string dir, int nbpop, int N, int *Nk, double *K, double** J, double duration, double dt, double Tst, double Tw, double *Iext, double *Tm, double **Tsyn, string path) {
